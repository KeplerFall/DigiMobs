package com.taverna.digimobs.block;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> DIGIVICE_BLOCK = registerBlock("digivice_block", ()-> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)));
